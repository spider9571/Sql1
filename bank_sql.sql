...
create table if not exists sbi_details(
age int,
job varchar(30),
marital varchar(30),
...
select * from sbi_details;
select * from sbi_details;
select age,loan,job from sbi_details;
select * from sbi_details; 


-- Maximum balance frm sbi bank details ans  71188
select max(balance)from sbi_details;

-- Min balance frm sbi bank details ans  -3313
select min(balance)from sbi_details;

-- List of person having loan
select * from sbi_details where loan = 'yes';

-- avg balance for all whos job  is admin
select avg(balance) from sbi_details where job ='admin';

-- Wherever  job is unemployed and age is 45
select * from sbi_details where job ='unemployed'and age < 45;
